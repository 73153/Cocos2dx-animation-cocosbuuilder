...
void InterfaceJNI::helloWorld()
{
	...
	// Get the class
	jclass mClass = env->FindClass("com/fallingscalemedia/Noah360/InternetConnection");
...
void InterfaceJNI::postMessageToFB()
{
	...
	jclass mClass = env->FindClass("com.fallingscalemedia.facebook/GetSocial");
...
void InterfaceJNI::postMessageToTweet()
{
	...
	jclass mClass = env->FindClass("com/fallingscalemedia/Noah360/Noah");
